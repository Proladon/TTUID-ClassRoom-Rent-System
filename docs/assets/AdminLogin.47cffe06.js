import{a1 as Ut,a2 as Ft,a3 as xe,a4 as Ve,a5 as J,a6 as F,a7 as Be,a8 as fe,a9 as xt,aa as Vt,ab as Bt,ac as p,ad as Wt,ae as We,af as jt,ag as Ht,ah as pe,ai as qt,aj as Kt,ak as x,al as V,am as B,an as zt,d as Gt,u as $t,a as Jt,b as Yt,r as Xt,K as Qt,o as je,D as Zt,w as Y,n as N,p as _,Q as He,L as qe,N as en,U as tn,y as nn,l as rn,C as sn,c as on}from"./vendor.783a2ae5.js";import{_ as Ke,e as an}from"./index.8f6fbf1a.js";/*! *****************************************************************************
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qi(n=Wt()){const e=We(n,"auth");return e.isInitialized()?e.getImmediate():un(n,{popupRedirectResolver:$i,persistence:[ri,zn,It]})}Xi("Browser");const Zi={"auth/user-not-found":"\u67E5\u7121\u6B64\u4FE1\u7BB1","auth/wrong-password":"\u5BC6\u78BC\u932F\u8AA4"};const er=nn("\u767B\u5165"),tr=Gt({setup(n){const e=$t(),t=Jt(),i=Qi(),r=Yt(),s=Xt(null),o=Qt({email:"",password:""}),c={email:{required:!0,trigger:"blur",message:"\u8ACB\u8F38\u5165\u6B63\u78BA\u96FB\u5B50\u4FE1\u7BB1",validator:an},password:{required:!0,message:"\u8ACB\u8F38\u5165\u6B63\u78BA\u5BC6\u78BC",trigger:"blur"}},a=async()=>{s.value.validate(async h=>{if(!h)try{const f=await jn(i,o.email,o.password);r.success("\u767B\u5165\u6210\u529F"),u(f.user),e.commit("SET_SIGNIN",!0),t.push({name:"Dashboard"})}catch(f){const g=f.code;r.error(Zi[g])}})},u=h=>{rn.set("user",{name:h,uid:h.uid,exp:sn(new Date).add(1,"d").unix()})},d=async()=>{s.value.validate(async h=>{h||await a()})};return(h,f)=>(je(),Zt(_(tn),{model:_(o),rules:c,ref:(g,P)=>{P.formRef=g,s.value=g}},{default:Y(()=>[N(_(qe),{label:"\u96FB\u5B50\u4FE1\u7BB1",path:"email"},{default:Y(()=>[N(_(He),{placeholder:"\u8ACB\u8F38\u5165",value:_(o).email,"onUpdate:value":f[0]||(f[0]=g=>_(o).email=g)},null,8,["value"])]),_:1}),N(_(qe),{label:"\u5BC6\u78BC",path:"password"},{default:Y(()=>[N(_(He),{type:"password","show-password-on":"click",placeholder:"\u8ACB\u8F38\u5165",value:_(o).password,"onUpdate:value":f[1]||(f[1]=g=>_(o).password=g)},null,8,["value"])]),_:1}),N(_(en),{class:"signin-btn",block:"",type:"primary",onClick:d},{default:Y(()=>[er]),_:1})]),_:1},8,["model"]))}});var nr=Ke(tr,[["__scopeId","data-v-2f1db475"]]);const ir={},rr={class:"admin-login"};function sr(n,e){const t=nr;return je(),on("main",rr,[N(t)])}var cr=Ke(ir,[["render",sr],["__scopeId","data-v-45b50082"]]);export{cr as default};
