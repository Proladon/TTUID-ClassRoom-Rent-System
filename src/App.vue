<template>
  <div class="header-container">
    ...
    <div class="info-btn-wrapper">
      <div class="btn info-btn info" @click="showRules = !showRules">
        <b>🔰 規定及事項</b>
      </div>
      <div class="btn info-btn info">
        <strong
          ><a
            href="https://id.ttu.edu.tw/var/file/63/1063/img/128/262024854.pdf"
            target="_blank"
            >📄 紙本表單</a
          ></strong
        >
      </div>
      <div class="btn info-btn rules" @click="showInfo = !showInfo">
        <b>❔ 關於</b>
      </div>
      <div class="btn func-btn show" @click="horizontal = !horizontal">
        <b>🔁 切換排版</b>
      </div>
    </div>
    ...
    <vue-final-modal v-model="showRules">
      <div class="modal-container modal-wrapper">
        ...
        <hr
          style="background-color: rgb(45, 56, 72); border: none; height: 1px"
        />

        <div class="rules-data">
          <div
            class="rules-block"
            v-for="rules in rulesData.rules"
            :key="rules"
          >
            <p>
          ...
          <p>
            <strong>{{ rulesData.notice.title }}</strong>
          </p>
        ...
        <p class="footer">
          <strong>※ 使用日當天申請不予借用，請提早辦妥借用程序 ※</strong>
        </p>
      </div>
    </vue-final-modal>
